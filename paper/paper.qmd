...
The noticeable delays experienced on subway routes such as the Yonge–University and Bloor–Danforth lines demonstrate the difficulties in catering to populated areas with high passenger demand.These routes are lifelines for Torontos commuters and any disruptions here can cause far reaching effects throughout the city.Targeted approaches like upgrading signaling systems increasing train frequency and offering updates could be considered to improve service dependability.In addition, requiring traffic control to supervise site could also enhance the movement of passengers. 
